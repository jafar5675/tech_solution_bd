                            ...
                            <form action="" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="about_project" id="compose-textarea" rows="3">{{ old('about_project', $getRecord->about_project) }}</textarea>
                                        <div style="color:red;">{{ $errors->first('about_project') }}</div>
                                    </div>
                                    <div class="form-group">
                                        <label for=""> Image</label>
                                        <img src="{{ asset('upload/project/' . $getRecord->image) }}"
