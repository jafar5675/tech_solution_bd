...
@section('content')
    ...
    <section class="page-header">
        <div class="page-header-bg" style="background-image: url({{ asset('upload/course/' . $getCourseDetail->image) }})">
        </div>
        <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="project-details__img-box">
                            <img src="{{ asset('upload/course/' . $getCourseDetail->image) }}" alt="">
                                ...
                                <ul class="list-unstyled project-details__details">
                                    <li>
                                        <div class="project-details__details-content">
                                            ...
                                            <p class="project-details__details-name">{{ $getCourseDetail->name }}</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="project-details__details-content">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="project-two__single">
                            ...
                            <div class="project-two__content">
                                <p class="project-two__sub-title">{{ $course->type }}</p>
                                <h3 class="project-two__title"><a
                                        href="{{ url('course-detail/' . $course->id) }}">{{ $course->name }}</a></h3>
                                <div class="project-two__arrow">
                                    <a href="{{ url('course-detail/' . $course->id) }}"><i
